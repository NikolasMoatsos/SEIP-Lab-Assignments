...
/**
 * <h1>Generate Histogram with Grades</h1> The HistogramGenerator takes as an
 * input a file with Integer grades, from the command line and generates a
 * histogram with the grades' frequency, using the JFreeChart charting library.
 * 
...
public class HistogramGenerator {
	...
	/**
	 * This method visualizes an array with the grades' frequencies, with a
	 * XYLineChart from the JFreeChart charting library.
	 * 
